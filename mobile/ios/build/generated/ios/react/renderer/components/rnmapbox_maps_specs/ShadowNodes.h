...
JSI_EXPORT extern const char RNMBXRainComponentName[];

/*
 * `ShadowNode` for <RNMBXRain> component.
 */
using RNMBXRainShadowNode = ConcreteViewShadowNode<
    RNMBXRainComponentName,
    RNMBXRainProps,
    RNMBXRainEventEmitter,
    RNMBXRainState>;
...
JSI_EXPORT extern const char RNMBXSnowComponentName[];

/*
 * `ShadowNode` for <RNMBXSnow> component.
 */
using RNMBXSnowShadowNode = ConcreteViewShadowNode<
    RNMBXSnowComponentName,
    RNMBXSnowProps,
    RNMBXSnowEventEmitter,
    RNMBXSnowState>;
