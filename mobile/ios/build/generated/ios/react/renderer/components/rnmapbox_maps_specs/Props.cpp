...
#endif
RNMBXRainProps::RNMBXRainProps(
    const PropsParserContext &context,
    const RNMBXRainProps &sourceProps,
    const RawProps &rawProps): ViewProps(context, sourceProps, rawProps),

    reactStyle(convertRawProp(context, rawProps, "reactStyle", sourceProps.reactStyle, {})) {}
    
#ifdef RN_SERIALIZABLE_STATE
ComponentName RNMBXRainProps::getDiffPropsImplementationTarget() const {
  return "RNMBXRain";
}

folly::dynamic RNMBXRainProps::getDiffProps(
    const Props* prevProps) const {
  static const auto defaultProps = RNMBXRainProps();
  const RNMBXRainProps* oldProps = prevProps == nullptr
      ? &defaultProps
      : static_cast<const RNMBXRainProps*>(prevProps);
  if (this == oldProps) {
    return folly::dynamic::object();
  }
  folly::dynamic result = HostPlatformViewProps::getDiffProps(prevProps);
...
#endif
RNMBXSnowProps::RNMBXSnowProps(
    const PropsParserContext &context,
    const RNMBXSnowProps &sourceProps,
    const RawProps &rawProps): ViewProps(context, sourceProps, rawProps),

    reactStyle(convertRawProp(context, rawProps, "reactStyle", sourceProps.reactStyle, {})) {}
    
#ifdef RN_SERIALIZABLE_STATE
ComponentName RNMBXSnowProps::getDiffPropsImplementationTarget() const {
  return "RNMBXSnow";
}

folly::dynamic RNMBXSnowProps::getDiffProps(
    const Props* prevProps) const {
  static const auto defaultProps = RNMBXSnowProps();
  const RNMBXSnowProps* oldProps = prevProps == nullptr
      ? &defaultProps
      : static_cast<const RNMBXSnowProps*>(prevProps);
  if (this == oldProps) {
    return folly::dynamic::object();
  }
  folly::dynamic result = HostPlatformViewProps::getDiffProps(prevProps);
