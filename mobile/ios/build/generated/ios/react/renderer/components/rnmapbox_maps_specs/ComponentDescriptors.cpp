...
registry->add(concreteComponentDescriptorProvider<RNMBXRainComponentDescriptor>());
...
registry->add(concreteComponentDescriptorProvider<RNMBXSnowComponentDescriptor>());
