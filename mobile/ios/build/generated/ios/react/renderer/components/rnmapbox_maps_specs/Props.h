...
class RNMBXRainProps final : public ViewProps {
 public:
  RNMBXRainProps() = default;
  RNMBXRainProps(const PropsParserContext& context, const RNMBXRainProps &sourceProps, const RawProps &rawProps);
...
class RNMBXSnowProps final : public ViewProps {
 public:
  RNMBXSnowProps() = default;
  RNMBXSnowProps(const PropsParserContext& context, const RNMBXSnowProps &sourceProps, const RawProps &rawProps);
