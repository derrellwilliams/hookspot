...
using RNMBXRainComponentDescriptor = ConcreteComponentDescriptor<RNMBXRainShadowNode>;
...
using RNMBXSnowComponentDescriptor = ConcreteComponentDescriptor<RNMBXSnowShadowNode>;
